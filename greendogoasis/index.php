...
<main>
    <section class="hero">
        <header>
            <h2 class="section-title hero">Help Us Build Green Dog Oasis.</h2>
        </header>
        <div class="btn-group">
    ...
    <section class="welcome">
        ...
        <div class="rightcol">
            <div class="section-img">
                <img class="mobile-img" src="images/kody.jpeg" alt="small dog sitting on the grass, sheet metal and bricks lay behind him." />
            </div>
        </div>
    </section>
    ...
    <section class="get-involved">
        <div class="leftcol">
            <div class="section-img">
                <img class="mobile-img" src="images/jeep.jpeg" alt="jeep parked in the grass " />
            </div>
        </div>
        ...
        <div class="rightcol">
            ...
            <a href="contactme.php" class="btn btn-secondary">Contact Us</a>
        </div>
    </section>
</main>
